    ...
    <div style={S.app}>
      ...
      <header style={S.header}>
        ...
        <div style={S.summaryRow}>
          <SummaryPill label="comptes" value={accounts.length} color="#c9a8ff" />
          <SummaryPill label="faibles" value={counts.weak} color="#ffb84d" />
          <SummaryPill label="bannis" value={counts.banned} color="#ff5d7a" />
        </div>
      </header>
...
const S = {
  ...
  logoMark: {
    ...
    height: 34,
    borderRadius: 9,
    background: 'linear-gradient(135deg, #7c3aed, #c9a8ff)',
    display: 'flex',
    alignItems: 'center',
    justifyContent: 'center',
    fontSize: 15,
  ...
  pillValue: { display: 'block', fontSize: 16, fontWeight: 800 },
  pillLabel: { display: 'block', fontSize: 9.5, color: '#7a6a95', marginTop: 1, letterSpacing: '0.04em' },
  tabs: {
    display: 'flex',
    gap: 6,
    background: '#150a26',
